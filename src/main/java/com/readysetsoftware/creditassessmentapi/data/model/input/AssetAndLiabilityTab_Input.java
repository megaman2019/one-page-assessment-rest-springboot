...
@NoArgsConstructor
@Data
@Table(name ="tblAssetAndLiabilityTab_Input")
public class AssetAndLiabilityTab_Input implements Serializable {
...
//    @JsonIgnoreProperties("assetAndLiabilityTab_Input")
//    private Application application;

    @OneToMany(mappedBy = "assetAndLiabilityTabInput")
