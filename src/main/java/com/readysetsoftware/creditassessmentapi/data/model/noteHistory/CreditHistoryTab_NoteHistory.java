...
@NoArgsConstructor
@Data
@Table(name ="vCreditHistoryTab_NoteHistory")
public class CreditHistoryTab_NoteHistory extends Shared_NoteHistory {
    @ManyToOne
    @JoinColumn(
        name = "iAppID",
    ...
    private CreditHistoryTab_Input creditHistoryTabInput;
