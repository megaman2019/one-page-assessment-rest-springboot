...
@NoArgsConstructor
@Data
@Table(name ="vTransactionTab_NoteHistory")
public class TransactionTab_NoteHistory extends Shared_NoteHistory {
    ...
    private TransactionTab_Input transactionTabInput;
