...
@NoArgsConstructor
@Data
@Table(name ="tblConditionTab_Input")
public class ConditionTab_Input implements Serializable {
...
//    @JsonIgnoreProperties("conditionTab_Input")
//    private Application application;

    @OneToMany(mappedBy = "conditionTabInput")
