...
@NoArgsConstructor
@Data
@Table(name ="tblCreditHistoryTab_Input")
public class CreditHistoryTab_Input implements Serializable {
...
//    @JsonIgnoreProperties("creditHistoryTab_Input")
//    private Application application;

    @OneToMany(mappedBy = "creditHistoryTabInput")
