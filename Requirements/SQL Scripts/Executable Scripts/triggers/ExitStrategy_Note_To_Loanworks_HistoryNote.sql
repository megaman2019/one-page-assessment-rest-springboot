...
/****** Object:  Trigger [dbo].[ExitStrategy_Note_To_Loanworks_HistoryNote]    Script Date: 6/07/2022 4:06:23 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE TRIGGER [dbo].[ExitStrategy_Note_To_Loanworks_HistoryNote] 
   ON  [dbo].[tblExitStrategyTab_Input] 
   AFTER INSERT,UPDATE
AS 
...
DECLARE @NOTE_SUB_CATEGORY VARCHAR(50) = 'Exit Strategy';
...
BEGIN
	...
	*/
    ...
    BEGIN
		...
		-- UPDATE tblExitStrategyTab_Input set notes = '' where appid = @iAppID
	END
END
GO

ALTER TABLE [dbo].[tblExitStrategyTab_Input] ENABLE TRIGGER [ExitStrategy_Note_To_Loanworks_HistoryNote]
GO
