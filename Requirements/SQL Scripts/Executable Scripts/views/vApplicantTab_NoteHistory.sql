...
/****** Object:  View [dbo].[vApplicantTab_NoteHistory]    Script Date: 6/07/2022 12:52:51 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vApplicantTab_NoteHistory] AS 
...
WHERE 
	...
	AND _NoteEntity.iNoteSubCategory = (SELECT TOP 1 iSubCategoryId FROM Loanworks_v18..tblNoteSubCategory WHERE varName = 'Applicants')
GO
