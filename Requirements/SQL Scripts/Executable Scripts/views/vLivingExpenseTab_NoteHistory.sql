...
/****** Object:  View [dbo].[vLivingExpenseTab_NoteHistory]    Script Date: 6/07/2022 12:58:36 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vLivingExpenseTab_NoteHistory] AS 
...
WHERE 
	...
	AND _NoteEntity.iNoteSubCategory = (SELECT TOP 1 iSubCategoryId FROM Loanworks_v18..tblNoteSubCategory WHERE varName = 'Living Expenses')
GO
