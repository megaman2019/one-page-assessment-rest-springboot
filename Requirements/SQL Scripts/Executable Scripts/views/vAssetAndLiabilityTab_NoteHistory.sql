...
/****** Object:  View [dbo].[vAssetAndLiabilityTab_NoteHistory]    Script Date: 6/07/2022 12:54:35 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vAssetAndLiabilityTab_NoteHistory] AS 
...
WHERE 
	...
	AND _NoteEntity.iNoteSubCategory = (SELECT TOP 1 iSubCategoryId FROM Loanworks_v18..tblNoteSubCategory WHERE varName = 'Assets and Liabilities')
GO
