...
/****** Object:  View [dbo].[vSettlementSpecialConditions]    Script Date: 6/07/2022 1:01:55 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vSettlementSpecialConditions]
...
FROM
	(
		...
		HAVING
			ISNULL(tblAppSpecialConditions.iLinkedConditionCat,0) = 1 -- settlement condition
			AND tblConditionCategory.cConditionCat IS NOT NULL
