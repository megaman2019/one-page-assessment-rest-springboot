...
/****** Object:  View [dbo].[vServicingTab_NoteHistory]    Script Date: 6/07/2022 1:01:06 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vServicingTab_NoteHistory] AS 
...
WHERE 
	...
	AND _NoteEntity.iNoteSubCategory = (SELECT TOP 1 iSubCategoryId FROM Loanworks_v18..tblNoteSubCategory WHERE varName = 'Servicing')
GO
