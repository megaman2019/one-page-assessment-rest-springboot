...
/****** Object:  View [dbo].[vIncomeTab_NoteHistory]    Script Date: 6/07/2022 12:58:20 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vIncomeTab_NoteHistory] AS 
...
WHERE 
	...
	AND _NoteEntity.iNoteSubCategory = (SELECT TOP 1 iSubCategoryId FROM Loanworks_v18..tblNoteSubCategory WHERE varName = 'Incomes')
GO
