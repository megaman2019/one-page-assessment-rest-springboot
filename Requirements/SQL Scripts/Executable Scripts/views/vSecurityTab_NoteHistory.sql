...
/****** Object:  View [dbo].[vSecurityTab_NoteHistory]    Script Date: 6/07/2022 1:00:52 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vSecurityTab_NoteHistory] AS 
...
WHERE 
	...
	AND _NoteEntity.iNoteSubCategory = (SELECT TOP 1 iSubCategoryId FROM Loanworks_v18..tblNoteSubCategory WHERE varName = 'Securities')
GO
