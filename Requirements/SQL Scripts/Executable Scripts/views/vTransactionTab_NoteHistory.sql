...
/****** Object:  View [dbo].[vTransactionTab_NoteHistory]    Script Date: 6/07/2022 1:02:13 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vTransactionTab_NoteHistory] AS 
...
WHERE 
	...
	AND _NoteEntity.iNoteSubCategory = (SELECT TOP 1 iSubCategoryId FROM Loanworks_v18..tblNoteSubCategory WHERE varName = 'Transactions')
GO
