...
/****** Object:  View [dbo].[vExitStrategyTab_NoteHistory]    Script Date: 6/07/2022 12:57:43 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vExitStrategyTab_NoteHistory] AS 
...
WHERE 
	...
	AND _NoteEntity.iNoteSubCategory = (SELECT TOP 1 iSubCategoryId FROM Loanworks_v18..tblNoteSubCategory WHERE varName = 'Exit Strategy')
