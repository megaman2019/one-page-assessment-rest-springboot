...
/****** Object:  View [dbo].[vConditionTab_NoteHistory]    Script Date: 6/07/2022 12:56:19 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vConditionTab_NoteHistory] AS 
...
WHERE 
	...
	AND _NoteEntity.iNoteSubCategory = (SELECT TOP 1 iSubCategoryId FROM Loanworks_v18..tblNoteSubCategory WHERE varName = 'Conditions')
GO
